...
class Logger:
    ...
    def __init__(self, context, console_verbosity=hou.severityType.Message):
        ...
        if (
            console_verbosity_settings == None
            and console_verbosity_settings not in console_verbosity_map.keys()
        ):
            console_verbosity_settings = Logger.default_console_verbosity

        hou_console_verbosity_settings = console_verbosity_map[
            console_verbosity_settings
        ]
